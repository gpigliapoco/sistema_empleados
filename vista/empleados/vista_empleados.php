    ...
    <div class="box box-primary box-solid">
        <div class="box-header with-border" style="text-align:center">
            ...
            <div class="box-tools pull-right">
                <button class="btn btn-success" style="width:100%" onclick="cargar_contenido('contenido_principal','empleados/registro_empleados.php')"><i class="glyphicon glyphicon-plus"></i>&nbsp;Nuevo Registro</button>
            </div>
            <!-- /.box-tools -->
        </div>
        <!-- /.box-header -->
